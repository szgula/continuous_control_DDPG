...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, enable_priority=False, BUFFER_SIZE=int(1e5), BATCH_SIZE=128, GAMMA=0.99, TAU=1e-3, LR_ACTOR=1e-5, LR_CRITIC=1e-4, WEIGHT_DECAY=0):
